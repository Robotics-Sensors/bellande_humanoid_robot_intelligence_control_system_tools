...
bool QNode::init() {
  ...
  joint_offset_data_pub_ =
      ros_node.advertise<op3_tuning_module_msgs::JointOffsetData>(
          "/robotis/tuning_module/joint_offset_data", 0);
  joint_gain_data_pub_ =
      ros_node.advertise<op3_tuning_module_msgs::JointOffsetData>(
          "/robotis/tuning_module/joint_gain_data", 0);
  torque_enable_pub_ =
      ros_node.advertise<op3_tuning_module_msgs::JointTorqueOnOffArray>(
  ...
  get_present_joint_offset_data_client_ =
      ros_node.serviceClient<op3_tuning_module_msgs::GetPresentJointOffsetData>(
...
void QNode::sendTorqueEnableMsg(
    op3_tuning_module_msgs::JointTorqueOnOffArray msg) {
