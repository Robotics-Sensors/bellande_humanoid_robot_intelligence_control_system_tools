...
#ifndef humanoid_robot_tuner_client_QNODE_HPP_
#define humanoid_robot_tuner_client_QNODE_HPP_
...
#include "humanoid_robot_tuning_module_msgs/JointOffsetPositionData.h"
#include "humanoid_robot_tuning_module_msgs/JointTorqueOnOff.h"
...
public:
  ...
  void sendTorqueEnableMsg(humanoid_robot_tuning_module_msgs::JointTorqueOnOffArray msg);
  void sendJointOffsetDataMsg(humanoid_robot_tuning_module_msgs::JointOffsetData msg);
  void sendJointGainDataMsg(humanoid_robot_tuning_module_msgs::JointOffsetData msg);
  void sendCommandMsg(std_msgs::String msg);
  void sendTuningPoseMsg(std_msgs::String msg);
  bool isRefresh() { return is_refresh_; }
...
Q_SIGNALS:
  void loggingUpdated();
  void rosShutdown();
  void updatePresentJointOffsetData(
...
#endif /* humanoid_robot_tuner_client_QNODE_HPP_ */
