...
bool ActionEditor::initializeActionEditor(std::string robot_file_path,
  ...
  ctrl_ = humanoid_robot_intelligence_control_system_framework::
      RobotisController::getInstance();
  ...
  ctrl_->addMotionModule(
      (humanoid_robot_intelligence_control_system_framework::MotionModule *)
          ActionModule::getInstance());
  ...
  ros::NodeHandle nh;
  enable_ctrl_module_pub_ = nh.advertise<std_msgs::String>(
      "/humanoid_robot_intelligence_control_system/enable_ctrl_module", 0);
  ...
  for (std::map<std::string,
                humanoid_robot_intelligence_control_system_framework::Dynamixel
                    *>::iterator it = robot_->dxls_.begin();
