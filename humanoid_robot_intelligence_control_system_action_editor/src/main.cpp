...
#include "humanoid_robot_intelligence_control_system_action_editor/action_editor.h"
...
int main(int argc, char **argv) {
  ...
  humanoid_robot_intelligence_control_system_op::ActionEditor editor;
          ...
          if (strcmp(cmd, "exit") == 0) {
            ...
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0],
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::RightToLeft,
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::AllBody);
            else
              editor.printCmd("Need parameter");
            ...
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0],
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::RightToLeft,
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::UpperBody);
            else
              editor.printCmd("Need parameter");
            ...
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0],
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::RightToLeft,
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::LowerBody);
            else
              editor.printCmd("Need parameter");
          } else if (strcmp(cmd, "mlr") == 0) {
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0],
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::LeftToRight,
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::AllBody);
            else
              editor.printCmd("Need parameter");
            ...
            if (num_param > 0)
              editor.mirrorStepCmd(iparam[0],
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::SwitchEach,
                                   humanoid_robot_intelligence_control_system_op::ActionEditor::AllBody);
            else
              editor.printCmd("Need parameter");
