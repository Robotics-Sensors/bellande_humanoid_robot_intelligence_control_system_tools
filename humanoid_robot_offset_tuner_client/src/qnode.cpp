...
#include "../include/humanoid_robot_offset_tuner_client/qnode.hpp"
...
bool QNode::init() {
  ros::init(init_argc_, init_argv_, "humanoid_robot_offset_tuner_client");
...
void QNode::sendTorqueEnableMsg(
    humanoid_robot_offset_tuner_msgs::JointTorqueOnOffArray msg) {
...
void QNode::getPresentJointOffsetData(bool recalculate_offset) {
  ...
  if (get_present_joint_offset_data_client_.call(
    ...
    for (int id = 0;
         ...
         id++) {
      humanoid_robot_offset_tuner_msgs::JointOffsetPositionData _temp =
