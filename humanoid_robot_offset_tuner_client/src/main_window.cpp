...
#include "../include/humanoid_robot_offset_tuner_client/main_window.hpp"
#include <QMessageBox>
#include <QtGui>
#include <iostream>
...
namespace humanoid_robot_offset_tuner_client {
...
void MainWindow::publishTorqueMsgs(std::string &joint_name, bool torque_on) {
  humanoid_robot_offset_tuner_msgs::JointTorqueOnOffArray torque_array_msg;
  humanoid_robot_offset_tuner_msgs::JointTorqueOnOff torque_msg;
...
void MainWindow::updateJointOffsetSpinbox(
    humanoid_robot_offset_tuner_msgs::JointOffsetPositionData msg) {
...
void MainWindow::makeTabUI(QGroupBox *joint_widget, QGroupBox *torque_widget,
  ...
  for (std::map<int, std::string>::iterator map_it = offset_group.begin();
    ...
    QObject::connect(spingox_signalMapper, SIGNAL(mapped(QString)), this,
                     SLOT(changedSpinBoxValue(QString)));
