...
#include "humanoid_robot_intelligence_control_system_offset_tuner_msgs/GetPresentJointOffsetData.h"
#include "humanoid_robot_intelligence_control_system_offset_tuner_msgs/JointOffsetData.h"
#include "humanoid_robot_intelligence_control_system_offset_tuner_msgs/JointTorqueOnOffArray.h"
...
class OffsetTunerServer
    : public humanoid_robot_intelligence_control_system_framework::Singleton<OffsetTunerServer> {
...
private:
  ...
  humanoid_robot_intelligence_control_system_framework::RobotisController *controller_;
