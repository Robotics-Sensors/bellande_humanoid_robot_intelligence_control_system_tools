...
bool OffsetTunerServer::initialize() {
  // torque on dxls
  controller_ = humanoid_robot_intelligence_control_system_framework::RobotisController::getInstance();
  ...
  controller_->addMotionModule(
      (humanoid_robot_intelligence_control_system_framework::MotionModule *)BaseModule::getInstance());

  // Initialize RobotOffsetData
  for (std::map<std::string, humanoid_robot_intelligence_control_system_framework::Dynamixel *>::iterator dxls_it =
  ...
  send_tra_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/base/send_tra", 10,
                         &OffsetTunerServer::stringMsgsCallBack, this);
  joint_offset_data_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/offset_tuner/joint_offset_data", 10,
                         &OffsetTunerServer::jointOffsetDataCallback, this);
  joint_torque_enable_sub_ =
      ros_node.subscribe("/humanoid_robot_intelligence_control_system/offset_tuner/torque_enable", 10,
                         &OffsetTunerServer::jointTorqueOnOffCallback, this);
  command_sub_ = ros_node.subscribe("/humanoid_robot_intelligence_control_system/offset_tuner/command", 5,
                                    &OffsetTunerServer::commandCallback, this);
  offset_data_server_ = ros_node.advertiseService(
      "humanoid_robot_intelligence_control_system/offset_tuner/get_present_joint_offset_data",
...
void OffsetTunerServer::jointOffsetDataCallback(
    const humanoid_robot_intelligence_control_system_offset_tuner_msgs::JointOffsetData::ConstPtr &msg) {
  if (controller_->isTimerRunning()) {
...
void OffsetTunerServer::jointTorqueOnOffCallback(
    const humanoid_robot_intelligence_control_system_offset_tuner_msgs::JointTorqueOnOffArray::ConstPtr &msg) {
...
bool OffsetTunerServer::getPresentJointOffsetDataServiceCallback(
    humanoid_robot_intelligence_control_system_offset_tuner_msgs::GetPresentJointOffsetData::Request &req,
    humanoid_robot_intelligence_control_system_offset_tuner_msgs::GetPresentJointOffsetData::Response &res) {
  ...
  for (std::map<std::string, JointOffsetData *>::iterator map_it =
    ...
    humanoid_robot_intelligence_control_system_offset_tuner_msgs::JointOffsetPositionData joint_offset_pos;
