...
bool QNodeOP3::init() {
  ...
  status_msg_sub_ = ros_node.subscribe("/robotis/status", 10,
                                       &QNodeOP3::statusMsgCallback, this);
...
bool QNodeOP3::getIDJointNameFromIndex(const int &index, int &id,
                                       std::string &joint_name) {
  std::map<int, std::string>::iterator map_it;
  int count = 0;
...
int QNodeOP3::getModeSize() { return index_mode_table_.size(); }

// number of joints
int QNodeOP3::getJointSize() { return id_joint_table_.size(); }
...
void QNodeOP3::setJointControlMode(
...
void QNodeOP3::refreshCurrentJointControlCallback(
