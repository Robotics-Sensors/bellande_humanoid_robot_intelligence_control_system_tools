...
void QNodeOP3::init_default_demo(ros::NodeHandle &ros_node) {
  ...
  set_walking_param_pub =
      ros_node.advertise<op3_walking_module_msgs::WalkingParam>(
          "/robotis/walking/set_params", 0);
  get_walking_param_client_ =
      ros_node.serviceClient<op3_walking_module_msgs::GetWalkingParam>(
...
void QNodeOP3::updateHeadJointStatesCallback(
...
void QNodeOP3::applyWalkingParam(
