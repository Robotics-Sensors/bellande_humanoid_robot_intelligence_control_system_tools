...
void QNodeOP3::init_preview_walking(ros::NodeHandle &ros_node) {
  ...
  foot_step_command_pub_ =
      ros_node.advertise<op3_online_walking_module_msgs::FootStepCommand>(
          "/robotis/online_walking/foot_step_command", 0);
  walking_param_pub_ =
      ros_node.advertise<op3_online_walking_module_msgs::WalkingParam>(
          "/robotis/online_walking/walking_param", 0);
  set_walking_footsteps_pub_ =
      ros_node.advertise<op3_online_walking_module_msgs::Step2DArray>(
  ...
  joint_pose_msg_pub_ =
      ros_node.advertise<op3_online_walking_module_msgs::JointPose>(
  ...
  rviz_clicked_point_sub_ = ros_node.subscribe(
      "clicked_point", 0, &QNodeOP3::pointStampedCallback, this);
...
bool QNodeOP3::transformPose(const std::string &from_id,
...
// demo
void QNodeOP3::pointStampedCallback(
...
// interactive marker
void QNodeOP3::interactiveMarkerFeedback(
  ...
  for (int ix = preview_foot_types_.size() - 1; ix >= 0; ix--) {
    ...
    if (!clear) {
      ...
      if (preview_foot_types_[ix] ==
          op3_online_walking_module_msgs::Step2D::LEFT_FOOT_SWING) // left
      {
