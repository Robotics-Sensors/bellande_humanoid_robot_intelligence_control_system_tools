...
bool QNode::init() {
  ...
  joint_offset_data_pub_ =
      ros_node.advertise<op3_offset_tuner_msgs::JointOffsetData>(
          "/robotis/offset_tuner/joint_offset_data", 0);
  torque_enable_pub_ =
      ros_node.advertise<op3_offset_tuner_msgs::JointTorqueOnOffArray>(
  ...
  get_present_joint_offset_data_client_ =
      ros_node.serviceClient<op3_offset_tuner_msgs::GetPresentJointOffsetData>(
          "/robotis/offset_tuner/get_present_joint_offset_data");

  std::string default_config_path =
      ros::package::getPath("op3_offset_tuner_client") +
...
void QNode::sendTorqueEnableMsg(
    op3_offset_tuner_msgs::JointTorqueOnOffArray msg) {
