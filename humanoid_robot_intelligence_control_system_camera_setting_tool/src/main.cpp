...
#include "humanoid_robot_intelligence_control_system_camera_setting_tool/humanoid_robot_intelligence_control_system_camera_setting_tool.h"

int main(int argc, char **argv) {
  ros::init(argc, argv, "humanoid_robot_intelligence_control_system_camera_setting_tool");
  ...
  ros::Subscriber camera_param_sub =
      nh.subscribe("/humanoid_robot_intelligence_control_system_camera/set_param", 1, &setCameraParameterCallback);
  ros::Subscriber camera_params_sub =
      nh.subscribe("/humanoid_robot_intelligence_control_system_camera/set_params", 1, &setCameraParametersCallback);

  // web setting
  ros::NodeHandle nh_param("~");
  g_has_path = nh_param.getParam("yaml_path", g_param_path);

  g_param_pub = nh.advertise<humanoid_robot_intelligence_control_system_camera_setting_tool::CameraParams>(
      "/humanoid_robot_intelligence_control_system_camera/camera_params", 1);
  g_param_command_sub =
      nh.subscribe("/humanoid_robot_intelligence_control_system_camera/param_command", 1, &paramCommandCallback);
  g_set_param_client =
      nh.advertiseService("/humanoid_robot_intelligence_control_system_camera/set_camera_params", &setParamCallback);
  g_get_param_client =
      nh.advertiseService("/humanoid_robot_intelligence_control_system_camera/get_camera_params", &getParamCallback);
  ...
  dynamic_reconfigure::Server<
      humanoid_robot_intelligence_control_system_camera_setting_tool::CameraParamsConfig>::CallbackType callback_fnc;
  g_param_server.reset(
      new dynamic_reconfigure::Server<
          humanoid_robot_intelligence_control_system_camera_setting_tool::CameraParamsConfig>(config_mutex));
...
void publishParam() {
  humanoid_robot_intelligence_control_system_camera_setting_tool::CameraParams cam_params;
